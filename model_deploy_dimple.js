...
function verifyGoddessPose(calculatedAngle){
  for(i = 0; i<goddessAngleTarget.length(); i++){
    ...
    {
      if (i===0) {
      text('Fix your left Leg',350,200);
      ...
      for (let i = 0; i < skeleton.length; i++){
       ...
       if (i===1) {
        text('Fix your right Leg',350,200);
       ...
       if (i===2) {
        text('Bend your left Leg',350,200);
        pose.keypoints[11].position.x;
        pose.keypoints[11].position.y;
        pose.keypoints[13].position.x;
        pose.keypoints[13].position.y;
       ...
       if (i===3) {
        text('Bend your right Leg',350,200);
        pose.keypoints[12].position.x;
        pose.keypoints[12].position.y;
        pose.keypoints[14].position.x;
        pose.keypoints[14].position.y;
       ...
       if (i===4) {
        text('Fix your right hand',350,200);
        pose.keypoints[5].position.x;
        pose.keypoints[5].position.y;
       ...
       if (i===5) {
        text('Fix your left hand',350,200);
        pose.keypoints[12].position.x;
        pose.keypoints[12].position.y;
       ...
       if (i===8) {
        text('Bend your left knee and hand',350,200);
        pose.keypoints[5].position.x;
        pose.keypoints[5].position.y;
        pose.keypoints[15].position.x;
        pose.keypoints[15].position.y;
       ...
       if (i===9) {
        text('Bend your right knee and hand',350,200);
        pose.keypoints[10].position.x;
        pose.keypoints[10].position.y;
        pose.keypoints[16].position.x;
        pose.keypoints[16].position.y;
       ...
       if (i===10) {
        text('Bend your left knee and raise your left hand',350,200);
        pose.keypoints[5].position.x;
        pose.keypoints[5].position.y;
        pose.keypoints[13].position.x;
        pose.keypoints[13].position.y;
       ...
       if (i===11) {
        text('Raise your right knee and raise your right hand',350,200);
        pose.keypoints[14].position.x;
        pose.keypoints[14].position.y;
        pose.keypoints[10].position.x;
        pose.keypoints[10].position.y;
...
/*Overall Percent accuracy for Goddess Pose*/
  ...
  for(i = 0; i<warrior2AngleTarget.length(); i++){
    ...
    //For Vatsal + Dimple of specific angles relating to pose
        ...
        for (let i = 0; i < skeleton.length; i++){
         ...
         if (i===4) {
          text('Raise your left hand',350,200);
          pose.keypoints[5].position.x;
          pose.keypoints[5].position.y;
          pose.keypoints[7].position.x;
          pose.keypoints[7].position.y;
         ...
         if (i===5) {
          text('Raise your right hand',350,200);
          pose.keypoints[12].position.x;
          pose.keypoints[12].position.y;
          pose.keypoints[8].position.x;
          pose.keypoints[8].position.y;
         ...
         if (i===6) {
          text('Straighten your left hand',350,200);
          pose.keypoints[7].position.x;
          pose.keypoints[7].position.y;
          pose.keypoints[5].position.x;
          pose.keypoints[5].position.y;
         ...
         if (i===7) {
          text('Straighten your right hand',350,200);
          pose.keypoints[10].position.x;
          pose.keypoints[10].position.y;
          pose.keypoints[8].position.x;
          pose.keypoints[8].position.y;
         ...
         if (i===8) {
          text('Bend your left knee',350,200);
          pose.keypoints[5].position.x;
          pose.keypoints[5].position.y;
          pose.keypoints[15].position.x;
          pose.keypoints[15].position.y;
         ...
         if (i===9) {
          text('Bend your right knee',350,200);
          pose.keypoints[10].position.x;
          pose.keypoints[10].position.y;
          pose.keypoints[16].position.x;
          pose.keypoints[16].position.y;
         ...
         if (i===10) {
          text('Bend your left knee and straighten your hand',350,200);
          pose.keypoints[5].position.x;
          pose.keypoints[5].position.y;
          pose.keypoints[13].position.x;
          pose.keypoints[13].position.y;
         ...
         if (i===11) {
          text('Raise your right knee and straighten hand',350,200);
          pose.keypoints[14].position.x;
          pose.keypoints[14].position.y;
          pose.keypoints[10].position.x;
          pose.keypoints[10].position.y;
...
/*Overall Percent accuracy for Warrior 2 Pose*/
